...
const checkBirthdateIsLucky = () => {
  ...
  if (dob === "" || number === "") {
    ...
    if (sum % number === 0) {
      modalBody.innerHTML = `<div><h2>Your birthday is lucky!</h2></div><div><img src="/assets/happy.gif" width="100%"/></div>`;
      modal.style.display = "block";
    } else {
      modalBody.innerHTML = `<div><h2>Ohoo! Your birthday is not lucky!!</h2></div><div><img src="/assets/sad.gif" width="80%"/></div>`;
      modal.style.display = "block";
    }
  }
};
